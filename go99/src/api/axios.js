...
export const apis = {
  ...
  getCircles: (project_id) =>
    instance.get(`/api/projects/${project_id}/circles`),
  ...
  addFeedBack: (circles_id, contents) =>
    instance.post(`/api/circles/${circles_id}/feedback`, contents),
  editFeedBack: (circles_id, contents) =>
    instance.put(`/api/circles/${circles_id}/feedback`, contents),
